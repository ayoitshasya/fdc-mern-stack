    ...
    <div className='w-full h-full flex flex-col'>
      ...
      <div className='w-full h-full flex flex-col justify-center items-center'>
        <div className='bg-[#FAFAFA] rounded-3xl p-4 px-8 flex flex-col items-center font-inter'>
          <h1 className='text-xl text-[#3D3D3D] font-medium mb-4'>Recommendation from FDC Convenor</h1>
          <form className='w-full text-[#7F7F7F] font-normal flex flex-col'>
            ...
            <input type="date" name="meetingDate" className='w-full border rounded-lg p-1 outline-none mt-1 mb-4 bg-white'/>
